//
//  PlayGameCellViewModelTests.swift
//  StatsTrackerTests
//
...
class PlayGameCellViewModelTests: XCTestCase {
    
    var sut: PlayGameCellViewModel!
    ...
    override func setUp() {
        ...
        sut = PlayGameCellViewModel(playerArray: playerArray, delegate: self)
        super.setUp()
    }
    ...
    func testConfigureTableViewCell() {
        ...
        tableView.register(PlayGameOffenseTableViewCell.self, forCellReuseIdentifier: "PlayGameOffenseTableViewCell")
        // When
        let indexPath = IndexPath(row: 0, section: 1)
        let cell = sut.tableView(tableView, cellForRowAt: indexPath) as! PlayGameOffenseTableViewCell
        // Then
...
extension PlayGameCellViewModelTests: PlayGameCellViewModelDelegate {
