...
class PlayerModelTests: XCTestCase {
    ...
    func testConvenienceInit_success() throws {
        ...
        XCTAssertEqual(Constants.Empty.double, sut!.completions)
        XCTAssertEqual(Constants.Empty.double, sut!.throwaways)
        XCTAssertEqual(Constants.Empty.double, sut!.catches)
        XCTAssertEqual(Constants.Empty.double, sut!.drops)
